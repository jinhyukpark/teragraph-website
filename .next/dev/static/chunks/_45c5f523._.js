...
function useNotifications() {
        ...
        "useNotifications.useEffect": ()=>{
            ...
            if (stored) {
                try {
                    ...
                    setNotifications(parsed.map({
                        "useNotifications.useEffect": (n)=>({
                                ...n,
    ...
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[addNotification]": (title, message, type = "info", showBrowserNotification = true)=>{
    ...
    const markAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[markAsRead]": (id)=>{
            setNotifications({
    ...
    const removeNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[removeNotification]": (id)=>{
            setNotifications({
                "useNotifications.useCallback[removeNotification]": (prev)=>prev.filter({
                        "useNotifications.useCallback[removeNotification]": (n)=>n.id !== id
...
_s(useNotifications, "e2cH3u20k4qJ+FWVUGVZwcIGVwA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/contexts/NotificationContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotificationProvider({ children }) {
    _s();
    const notificationState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NotificationContext.Provider, {
        ...
        fileName: "[project]/contexts/NotificationContext.tsx",
        lineNumber: 29,
        columnNumber: 5
    }, this);
}
_s(NotificationProvider, "IRhpXdtZI1v3IUvFOuCXjKHJKAU=", false, function() {
    return [
...
//# sourceMappingURL=_45c5f523._.js.map