  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-primary-foreground">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center cursor-pointer hover:opacity-80 transition-opacity">
            <img src="/images/terragraph-logo.jpg" alt="TerraGraph - AI-Powered Data Intelligence" className="h-10 w-auto" />
          </Link>
      ...
      <section id="vision" className="py-24 relative overflow-hidden bg-black/20">
        <div className="absolute inset-0 z-0">
           <img src="/images/futuristic_horizon_with_digital_sunrise_and_connected_city.png" alt="Future Vision" className="w-full h-full object-cover opacity-10 mix-blend-screen" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-card/50 border-border/50 backdrop-blur-sm overflow-hidden h-full group hover:border-primary/50 transition-colors duration-300">
                <div className="h-48 overflow-hidden relative">
                  ...
                  <img src="/images/abstract_representation_of_artificial_intelligence.png" alt="AI Services" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <CardHeader>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-card/50 border-border/50 backdrop-blur-sm overflow-hidden h-full group hover:border-primary/50 transition-colors duration-300">
                <div className="h-48 overflow-hidden relative">
                  ...
                  <img src="/images/abstract_mobile_app_development_concept.png" alt="Mobile Development" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <CardHeader>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-card/50 border-border/50 backdrop-blur-sm overflow-hidden h-full group hover:border-primary/50 transition-colors duration-300">
                <div className="h-48 overflow-hidden relative">
                  ...
                  <img src="/images/abstract_creative_design_concept.png" alt="Design Services" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <CardHeader>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              <Link href="/" className="flex items-center mb-6 hover:opacity-80 transition-opacity cursor-pointer">
                <img src="/images/terragraph-logo.jpg" alt="TerraGraph - AI-Powered Data Intelligence" className="h-12 w-auto" />
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-4 text-muted-foreground">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span>manager@teragraph.io</span>
                </li>
                <li className="flex items-center gap-3">
